...
if(!isset($_SESSION["nom"]) || time()-$_SESSION["login_time_stamp"] >60)
{
...
<div class="container noheight" id="container">
    <div class="welcome-container">
        <h1>Benvingut!</h1>
        <div>Hola <?= $_SESSION['nom']?>, les teves darreres connexions són:</div>
        <div class="connections"> <?= llegir_connexions($_SESSION['email']) ?> </div>
